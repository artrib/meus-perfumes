...
if choice == "🔍 Pesquisar":
    ...
    if not df.empty:
        ...
        with col1:
            ...
            fig1.update_layout(showlegend=False, xaxis_title=None, yaxis_title=None, margin=dict(t=10, b=10))
        ...
        with col2:
            ...
            fig2.update_layout(yaxis={'categoryorder':'total ascending'}, xaxis_title=None, yaxis_title=None, margin=dict(t=10, b=10), height=700)
        ...
        with col3:
            ...
            fig3.update_layout(showlegend=True, legend=dict(orientation="h", y=-0.1, font=dict(size=18)), margin=dict(t=10, b=10))
        ...
        with col4:
            ...
            fig4.update_layout(yaxis={'categoryorder':'total ascending'}, xaxis_title=None, yaxis_title=None, margin=dict(t=10, b=10), height=500)
...
# --- ABA EDITAR ---
    ...
    if not df.empty:
        ...
        ocas_atuais = [x.strip() for x in str(df.loc[idx, "Ocasiões de Uso"]).split(",") if x.strip() in OCASIOES_OPCOES]
        est_val = df.loc[idx, "Estações do Ano"]
        est_idx = ESTACOES_LISTA.index(est_val) if est_val in ESTACOES_LISTA else 0
        ...
        with st.form("edit_form"):
            ...
            with c1:
                ...
                e_ocas = st.multiselect("Ocasiões", OCASIOES_OPCOES, default=ocas_atuais)
            with c2:
