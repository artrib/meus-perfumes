...
st.markdown("<h2 style='text-align:left; font-size:37px; color: #9ba1ab;'>Caixa dos Perfumes</h2>", unsafe_allow_html=True)
...
# =========================================================
        ...
        with col1:
            ...
            fig_yn = px.pie(df_pie, values='count', names='Periodo', hole=0.55, color_discrete_sequence=['#8f6903', '#0d0000'])
