...
# =========================================================
# CSS PERSONALIZADO (Ajustado para layout compacto)
# =========================================================
...
/* Remove margens dos rótulos para aproximar os campos */
[data-testid="stWidgetLabel"] {
    display: none !important;
}

/* Remove o espaço excessivo entre a pesquisa e a tabela */
...
# =========================================================
# CONSTANTES E TRATAMENTO DE TEXTO
# =========================================================
...
if choice == "🔍 Pesquisar":
    # Barra de Pesquisa e Seletor Compactos
    ...
    with col_filtro:
        ...
        local_busca = st.selectbox("", opcoes_busca)
    ...
    if search:
        ...
        for termo in termos:
            ...
            if local_busca == "Tudo":
                mask = result.apply(
                    lambda row: row.astype(str).map(remover_acentos).str.contains(t_norm).any(), axis=1
                )
            else:
    ...
    if not df.empty:
        ...
        with col1:
            ...
            fig_oc.update_layout(yaxis={'categoryorder': 'total ascending'}, xaxis_title=None, yaxis_title=None, margin=dict(t=20, b=10), height=350)
        ...
        with col3:
            ...
            fig3 = px.pie(c_fam, values='count', names=c_fam.columns[0], color_discrete_sequence=paleta_minimalista)
        ...
        if st.form_submit_button("Guardar"):
            if nome:
                ...
                new = pd.DataFrame([{
                    ...
                    "Ocasiões de Uso": ", ".join(oc), "Família Olfativa": f_c,
                    "Notas Olfativas": n_c, "Marca": marca, "Perfumista": padronizar_texto(perf)
                }])
