...
# =========================================================
        ...
        with col1:
            ...
            fig_yn = px.pie(df_pie, values='count', names='Periodo', hole=0.55, color_discrete_sequence=['#97c9cf', '#141414'])
        ...
        with col2:
            ...
            fig2 = px.bar(c_not, x="count", y="Notas Olfativas", orientation='h', text="count", color_discrete_sequence=['#607274'])
