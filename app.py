...
# =========================================================
# CARREGAR DADOS E CONFIGURAÇÕES DE VISUALIZAÇÃO
# =========================================================
...
if choice == "🔍 Pesquisar":
    ...
    if not df.empty:
        ...
        # --- NOVOS GRÁFICOS LADO A LADO ---
        st.markdown("<br><br>", unsafe_allow_html=True)
        col_fam, col_periodo = st.columns(2)
        ...
        with col_fam:
            ...
            fig3.update_layout(title="Famílias Olfativas", showlegend=True, legend=dict(orientation="h", yanchor="top", y=-0.2, xanchor="center", x=0.5), margin=dict(t=40, b=50), height=350)
        ...
        with col_periodo:
            ...
            fig_yn = px.pie(df_pie, values='count', names='Periodo', color_discrete_map={'DIA': '#C08261', 'NOITE': '#2C3333'})
            fig_yn.update_layout(title="Distribuição Dia vs Noite", showlegend=True, legend=dict(orientation="h", yanchor="top", y=-0.2, xanchor="center", x=0.5), margin=dict(t=40, b=50), height=350)
        ...
        with col4:
            ...
            fig6.update_layout(xaxis_title=None, yaxis_title=None, margin=dict(t=20, b=10), height=450)
