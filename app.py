...
if choice == "🔍 Pesquisar":
    ...
    result = df.copy()
    # Adiciona a coluna de seleção para edição
    ...
    if not df.empty:
        # Editor de dados com a coluna "Editar" sem ícone no topo
        ...
        # Se clicar no checkbox, guarda o nome e recarrega na aba Editar
        ...
        if not result.empty:
            ...
            with col_center:
                # Remove a coluna temporária "Editar" antes do download
...
# =========================================================
    ...
    if not df.empty:
        ...
        # Define o perfume selecionado (vindo da pesquisa ou manual)
        idx_default = 0
        ...
        # Limpar seleção vinda da pesquisa
        ...
        with st.form("edit"):
            ...
            if st.form_submit_button("Atualizar"):
                ...
                df.to_csv(DB_FILE, index=False, encoding='utf-8-sig')
                st.session_state.edit_perfume = None # Limpa após sucesso
